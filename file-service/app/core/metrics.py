...
files_uploaded = Counter("files_uploaded_total", "Uploaded files")
files_deleted = Counter("files_deleted_total", "Deleted files")
commands_published = Counter("rabbitmq_commands_published_total", "Published processing commands")
