...
events_processed = Counter("kafka_events_processed_total", "Stored Kafka events")
kafka_failures = Counter("kafka_processing_failed_total", "Kafka processing failures")
